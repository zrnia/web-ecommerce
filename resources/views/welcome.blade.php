            ...
            <div class="w-1/2 p-8">
                ...
                <form action="#">
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" placeholder="Enter your mail address" required>
                    </div>
                    <div class="mb-4">
                        <label for="password" class="block text-gray-700">Password</label>
                        <input type="password" id="password" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" placeholder="Enter password" required>
                    </div>
                    ...
                    <p class="mt-6 text-center text-gray-600">Don't have an account? <a href="#" class="text-indigo-500 hover:underline">Register here</a></p>
                </form>
            </div>
